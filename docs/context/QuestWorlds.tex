...
The {\em QuestWorlds} System Reference Document 0.41
(\quotation{QWSRD0.41}) describes the rules of {\em QuestWorlds}. You
may incorporate the rules as they appear in QWSRD0.4, wholly or in part,
into a derivative work, through the use of the {\em QuestWorlds} Open
Game License, Version 1.0. You should read and understand the terms of
that License before creating a derivative work from QWSRD0.3.
...
You should note that this is version of 0.41 of the {\em QuestWorlds}
...
\item
  ...
  District of Michigan. \#\# 0.2 Credits
\stopitemize
...
\section[title={Basic & Advanced
Mechanics},reference={basic-advanced-mechanics}]

As the {\em QuestWorlds} engine is oriented towards rules-light play, we
designate some mechanics as \quotation{Basic} and others as
\quotation{Advanced.}

Basic rules represent the minimum mechanical structure you need to play
a game with the feel of {\em QuestWorlds}, while advanced rules add
...
\subsection[title={Who Is This Document
...
GM presents to stand in your way. Stories advance by two methods:
conflict, where your PC is prevented from achieving their goals because
there is something that must be overcome, a {\bf story obstacle}, to
gain a desired person, thing, or even status: the {\bf prize}; or
revelation, where something must be overcome, a {\bf story obstacle}, to
learn a secret, uncover the past, or reach understanding: the
{\bf prize}.
...
your GM make an opposed roll pitting your characters {\bf ability} vs
...
below) you want to use to achieve that {\bf prize}, and how.
...
{\bf Flaws} maybe psychological weaknesses such as \quotation{Alcoholic}
or \quotation{Heroin Addict}, or physical weaknesses such as
\quotation{One-Eye,} \quotation{Wheelchair-Bound} or
...
\quotation{Radical Candor} that limit your behavior in some way. A
...
to use it to make your life more difficult, not easier. In some cases,
you may choose to record both an {\bf ability} that your GM may
interpret as a {\bf flaw} if circumstances suggest. You should not use
your {\bf flaw} to accomplish something; if you feel that is likely,
make it an {\bf ability} and discuss with the GM whether you want them
to draw on it as a {\bf flaw} at appropriate moments.
...
1--20, representing the {\bf target number (TN)} you need to roll or
less to succeed on your roll during a {\bf contest} (see §2.3 for more
details).

Once your {\bf ability} passes 20, you would always be able to roll
under it on a D20. So to allow abilities to scale over 20 {\bf scores}
we use of tiers of capability we refer to as {\bf Mastery}. To reflect
abilities (or {\bf resistance}s) higher than 20, either permanently
through character advancement or a temporarily with {\bf modifier} to a
contest roll, note a {\bf mastery} for every 20 points in the ability,
and treat what remains as the {\bf rating}. So, for an {\bf ability} of
27, we note one {\bf mastery} and a {\bf rating} of seven written as
\quotation{7M} and we write the {\bf rating} of 21, as 1M.
...
opponent. When both you and the resistance have {\bf masteries} the
cancel out.
...
experience, often through overcoming story obstacles to improve the
{\bf ability} in game, you may chose to set threshold for those
...
describe the actions of the NPCs or forces on the other side of the
conflict.
...
to work. We call these kinds or contests {\bf assured} contests because
...
overcoming an {\bf story obstacle}. Or they may want to give you a
...
suffer an adverse {\bf consequence} (see §2.7). The nature of this
adversity is up to the GM. It will probably be {\bf penalty} involving
...
your effort (see §2.6). Again, this is up to the GM to define. It could
be a {\bf bonus} to the {\bf tactic} used in the {\bf contest}, or to of
one of your relationships, etc.
...
The {\bf simple contest} {\em QuestWorlds}' primary resolution mechanic
for overcoming {\bf story obstacles}, and is used the most often where
the outcome is uncertain. It also provides the foundation for other
types of uncertain {\bf contest}, including several {\bf long} ones. As
such, it receives both an overview of key concepts here as well as a
more detailed treatment in §4.

At its most basic, a {\bf simple contest} can be summarized as follows:
...
{\bf consequences} or {\bf benefits} (see §2.6) is your {\bf target
number}.
...
would help you overcome the {\bf story obstacle}. This as the
\quotation{key moment} where we focus on your PC. Use this moment to
reveal your PC's strengths to the group.

Your GM will determine if your {\bf tactic} passes a {\bf credibility
test}. If you try to jump a 100 meters gap or run faster than a speeding
...
{\bf tactics} are allowed for that game as part of an {\em Extraordinary
Powers Framework}.
...
When setting {\bf resistance}s it is important to understand that whilst
...
\item
  ...
  {\bf result} possible.
\item
  {\bf Success}: If the die roll is less than the {\bf TN} and not a
  {\bf fumble}, you succeed, but there is nothing remarkable about the
  success.
\item
...
comparing your roll with your opponents. So you might *{\bf succeed},
...
\item
  ...
  PCs, his hover bike, weaving in and out of traffic, but he crashes
  into a parked car, spilling Ath'Zul and the stolen artefact over the
  road.
\stopitemize
...
these are {\bf contest}s with binary {\bf outcomes}, where only two
...
participants, or they can resolve the ties in your favor as a
{\bf victory}.
...
in that order). A {\bf bump} down reduces {\bf result} by one step,
...
outcome could change as a effect of gaining a different {\bf result}.
...
This allows {\em QuestWorlds} to represent large differences in ability
or {\bf resistance}.

If the {\bf resistance} one or more levels of {\bf mastery} greater than
you, your GM can {\bf bump} their roll.
...
cannot {\bf bump} up from your critical, then you instead {\bf bump} the
...
then your GM should treat is as an {\bf assured contest}. If the GM
wants you to roll, to find out how well you did, your roll is
{\bf bumped} up by the {\bf resistance}.
...
to augment a {\bf keyword}, or another {\bf breakout} from the same
{\bf keyword}. However, {\bf augments} from other players supporting you
can add together with your own, along with other {\bf modifiers},
including those from {\bf benefits} and from {\bf plot augments}.
...
{\bf keyword}. For example, if you had they *keyword{\bf 
\quotation{Gangster} and decide to inform on a fellow mobster, your GM
might invoke the }flaw{\bf  of \quotation{Code of Silence} even if it is
not a }breakout{\bf  under you }keyword{\bf ; this is particularly
appropriate where facts such as the \quotation{Code of Silence} have
been established in game. Even if you overcome your }flaw{\bf , and
inform on your fellow mobster, the GM might still impose a }penalty{\bf 
on use of the }keyword** to interact with your crime family for having
breached the \quotation{Code of Silence.}
...
{\bf outcome} is far more decisive than a 5-4 {\bf outcome} for example.
...
PC. During play you can {\bf burn} a point from this pool, after which
it is lost. When you {\bf burn} a {\bf story point} you can edit the
story in your PC or group's favor. You can either do this to improve
your {\bf result} via a {\bf bump} (see §7.1) or to introduce a helpful
fact into the world via a {\bf plot edit} (see \$7.2).

You can decide to spend one of your group's {\bf story points} from the
{\bf pool} at any time. You do not agreement from the other players to
do so.

Your GM may feel that the genre they are playing requires a greater pool
of {\bf story points} as the heroes never seem to lose. You can create a
larger {\bf story point pool} but beware that failure and reversals of
fortune for the hero are part of most {\em interesting} stories. It can
be unwise for the GM to remove all sense of threat from the players by
giving them a {\bf story point pool} from which they can {\bf bump} any
roll, or remove all branches of the story that stem from {\bf defeat}.
...
pool} may become exhausted. The GM has three alternative strategies for
...
Ultimately your GM is always the arbiter of how the {\bf story point
pool refreshes}. On a refresh your {\bf story points} pool resets to one
{\bf story point} per PC.
...
\subsubsection[title={SIMPLE CONTEST
TABLE},reference={simple-contest-table}]
...
\subsubsection[title={GROUP SIMPLE CONTEST
TABLE},reference={group-simple-contest-table}]
...
\subsubsection[title={DEGREE OF VICTORY
TABLE},reference={degree-of-victory-table}]
...
\subsubsection[title={RISING ACTION CONTEST
TABLE},reference={rising-action-contest-table}]
...
\subsubsection[title={CLIMACTIC STATE OF ADVERSITY
TABLE},reference={climactic-state-of-adversity-table}]
...
\subsubsection[title={EXTENDED CONTEST
TABLE},reference={extended-contest-table}]
...
\subsubsection[title={CHAINED CONTEST
TABLE},reference={chained-contest-table}]
...
\subsubsection[title={CONSEQUENCES OF DEFEAT
TABLE},reference={consequences-of-defeat-table}]

\startplacetable[location=none]
\startxtable
\startxtablehead[head]
\startxrow
\startxcell[align=middle,width={0.09\textwidth}] Defeat Level \stopxcell
\startxcell[align=middle,width={0.14\textwidth}] State of
Adversity \stopxcell
\startxcell[align=middle,width={0.77\textwidth}] Penalty \stopxcell
\stopxrow
\stopxtablehead
\startxtablebody[body]
\startxrow
\startxcell[align=middle,width={0.09\textwidth}] Marginal \stopxcell
\startxcell[align=middle,width={0.14\textwidth}] Hurt \stopxcell
\startxcell[align=middle,width={0.77\textwidth}] --3 penalty to
appropriate abilities \stopxcell
\stopxrow
\startxrow
\startxcell[align=middle,width={0.09\textwidth}] Minor \stopxcell
\startxcell[align=middle,width={0.14\textwidth}] Impaired \stopxcell
\startxcell[align=middle,width={0.77\textwidth}] --6 penalty to
appropriate abilities \stopxcell
\stopxrow
\startxrow
\startxcell[align=middle,width={0.09\textwidth}] Major \stopxcell
\startxcell[align=middle,width={0.14\textwidth}] injured \stopxcell
\startxcell[align=middle,width={0.77\textwidth}] --9 penalty to
appropriate abilities \stopxcell
\stopxrow
\stopxtablebody
\startxtablefoot[foot]
\startxrow
\startxcell[align=middle,width={0.09\textwidth}] Complete \stopxcell
\startxcell[align=middle,width={0.14\textwidth}] Dying \stopxcell
\startxcell[align=middle,width={0.77\textwidth}] No actions allowed. If
...
\subsubsection[title={BENEFITS OF VICTORY
TABLE},reference={benefits-of-victory-table}]
...
\subsubsection[title={HEALING RESISTANCES
TABLE},reference={healing-resistances-table}]
...
\subsubsection[title={RESOURCE NOTATION
TABLE},reference={resource-notation-table}]
...
\subsubsection[title={RESOURCE DEPLETION
TABLE},reference={resource-depletion-table}]
...
\subsubsection[title={RESOURCE FLUCTUATION
TABLE},reference={resource-fluctuation-table}]
