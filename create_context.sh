...
pandoc markdown/QuestWorlds.md -s -t context --toc --top-level-division=chapter --template=context.book.template -o docs/context/QuestWorlds.book.tex -V mainfont:'ebgaramond' -V fontsize:'12pt' --lua-filter filters/stripHeaderNumbers.lua
echo done.
